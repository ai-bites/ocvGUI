...
class RobustMatcher {
  ...
  public:
      ...
      cv::Mat ransacTest(const std::vector<cv::DMatch>& matches,
                         ...
                         std::vector<cv::DMatch>& outMatches, int methodIdx)
      {
      ...
      cv::Mat match(cv::Mat& image1, cv::Mat& image2, // input images
        ...
        cv::Mat fundemental= ransacTest(symMatches, keypoints1, keypoints2, matches, methodIdx);
